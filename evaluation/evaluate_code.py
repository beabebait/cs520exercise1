...
# === Configuration ===
OUTPUT_DIR = "data/generated"  # directory with problem_1.json ... problem_10.json
RESULTS_FILE = "evaluation/pass_at_k_results.csv"
K = 10  # pass@k
...
for fname in tqdm(json_files, desc="Evaluating problems"):
    ...
    for model_key in ["gpt_cot", "gpt_selfdebug", "qwen_cot", "qwen_selfdebug"]:
